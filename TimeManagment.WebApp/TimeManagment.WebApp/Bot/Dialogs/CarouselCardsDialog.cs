...
namespace TimeManagment.WebApp.Bot.Dialogs
{
    [Serializable]
    public class CarouselCardsDialog : IDialog<IMessageActivity>
    {
        private readonly IAttachmentFactory _attachmentFactory;

        public CarouselCardsDialog(IAttachmentFactory attachmentFactory)
        {
        ...
        private IList<Attachment> GetCardsAttachments()
        {
            ...
            {
                _attachmentFactory.CreateHeroCard(
                    "Azure Storage",
                ...
                _attachmentFactory.GetThumbnailCard(
                    "Document DB",
                ...
                _attachmentFactory.CreateHeroCard(
                    "Azure Function",
                    "Process events with a server-less code architecture",
                    "An event-based server-less compute experience to accelerate your development. It can scale based on demand and you pay only for the resources you consume.",
